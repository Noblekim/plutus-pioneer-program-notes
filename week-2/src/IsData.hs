...
-- Create a new type for the redeemer.
newtype MySillyRedeemer = MySillyRedeemer Integer

-- Template Haskell function that takes a type and writes an instance for the types and
-- splices it in.
...
grab r = do
    ...
    let orefs   = fst <$> Map.toList utxos
        ...
        -- Use PlutusTx.toBuiltInData for custom types.
